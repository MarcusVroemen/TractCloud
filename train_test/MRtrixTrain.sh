...
num_f_brain=50000                # the number of streamlines in a brain
...
out_path=../ModelWeights/Data${input_data}_Rot${rot_ang_lst}Scale-${scale_ratio_range}Trans${trans_dis}AugTimes${aug_times}_Unrelated100HCP_${model_name}_${encoding}encoding/${local_global_rep_folder}
...
# Data
input_data="MRtrix_100"         # training data, 800 clusters + 800 outliers
num_f_brain=60000                # the number of streamlines in a brain
num_p_fiber=15                  # the number of points on a streamline
rot_ang_lst="45_10_10"          # data rotating
scale_ratio_range="0.45_0.05"   # data scaling
trans_dis=50                    # data translation
...
# Data
input_data="MRtrix_100"         # training data, 800 clusters + 800 outliers
num_f_brain=80000                # the number of streamlines in a brain
num_p_fiber=15                  # the number of points on a streamline
rot_ang_lst="45_10_10"          # data rotating
scale_ratio_range="0.45_0.05"   # data scaling
trans_dis=50                    # data translation
